...
// Import actor images
import mohanlalImg from '../assets/mohanlal.jpg';
import fahadhImg from '../assets/fahadh.jpg';
import sureshImg from '../assets/suresh.jpg';
import prithivrajImg from '../assets/prithviraj.jpg';
...
const AudioRoastPage = ({ spotifyData, onBack }) => {
  ...
  const handleGetRoasted = async () => {
    ...
    try {
      ...
      const result = await generateAudioRoast(audioBase64, selectedActor, severity, spotifyData);
