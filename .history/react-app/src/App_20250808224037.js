...
1. Complete the Spotify authorization in the popup window
2. You'll be redirected to a GitHub page
3. Look at the URL and copy the 'access_token' value
4. Come back here and paste it when prompted`);
    
    // Wait a bit then prompt for token
    setTimeout(() => {
      const token = prompt('Please paste your access_token here:');
      if (token && token.trim()) {
