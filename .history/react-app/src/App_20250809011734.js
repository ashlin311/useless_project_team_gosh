          ...
          <>
            ...
            <div className="login-section">
              ...
              <div style={{marginTop: '20px', padding: '10px', background: '#f0f0f0', borderRadius: '5px', fontSize: '12px'}}>
                ...
                <button 
                  onClick={() => {
                    const token = 'BQAHi81c-S430c2d5TWS7_RP2fGM4Knu5dHRR_R-XnFIXvp5KlN77ubrOEO6cA2agtmhJgrnOwIqGK6RNP75LQ7O6rrJxqGWvFc73EAuOZTR8pNorIVWTSoetxS0Px8i1Ni0wNrtFB_wKDz7T641idDV5GerYFIAD_5F29uCH5UzsretZ81hsCZnpdHln0KGmCGulgZ7ZssSUMryKjmwhewOJbJuP4BJtM6oaaBrsynRFe5dd5iLExjI7sTP7HkgSoBl2LPmp4oXzgVQ_oP2r2E2mBzjSvQoUJryCVwOTFMAJ2yXDIWLbRcSLG4V';
                    window.localStorage.setItem('spotify_token', token);
                    setAccessToken(token);
                    fetchUserProfile(token);
                  }} 
