          ...
          <>
            ...
            <div className="login-section">
              ...
              <div style={{marginTop: '20px', padding: '10px', background: '#f0f0f0', borderRadius: '5px', fontSize: '12px'}}>
                ...
                <button 
                  onClick={() => {
                    const token = 'BQChCb9w78WRAC28LZ4IPxMbs82m7UtV0mDbMqtcJuYIN0gHrCkQGQTlwJbSukglAA-dNpKxg7LUUtk02UFXGgLybn54vWq26jLLnz8dmTrA59IB091ji0arIHNxuQNq4CTmGjNYqZCj0KhxdCMMts7gZU9Y6mX8NQctwpxeoiz8Ry7Vt45Y8TRYW4GIjxKMpWB2sIrE7JviYJIbbJqK6q9stuyvFeChcPVSiMp2-QDKoEeK9onpdnA9upSEqZZFehgKMF9YVWveVITcYmokbIEsSc4VEz_HxeFQikilzCvfqh-150x8L70pCOx0';
                    window.localStorage.setItem('spotify_token', token);
                    setAccessToken(token);
                    fetchUserProfile(token);
                  }} 
