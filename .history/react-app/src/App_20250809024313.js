...
function App() {
  ...
  const [currentPage, setCurrentPage] = useState('login'); // 'login', 'actor-selection', 'roasting', 'audio-roasting'
          ...
          <>
            ...
            <div className="login-section">
              ...
              <div style={{marginTop: '20px', padding: '10px', background: '#f0f0f0', borderRadius: '5px', fontSize: '12px'}}>
                ...
                <button 
                  onClick={() => {
                    const token = 'BQB-y0DprhloVZazUFCqIqzI566rm05D-1owTw30wqkArxLU0W-4Z0JWRL8i4miZTHEn0-3LqDFiJLPsExzmnoksjz5Sla0rKqail9dL4kHKaSMWsABmBCjlsIQ2k3kF1i_YRwOgIufg7BLaJEOg4IOGitHGyuTsFDz2YwfPvh9QdpfJc5KoQtytfNAPKKP2VVLaQENWOYST2fZal6-zJ8f2EIaQrrKNjRYlsgwGUZ5befWI6udLmsG6TLoyhRMp-vOjUT06p2rQvGBTRvNUww6w_Clg8jKzITEAxuWKnOx08SHCHw6J5x7KytVX';
                    window.localStorage.setItem('spotify_token', token);
                    setAccessToken(token);
                    fetchUserProfile(token);
                  }} 
